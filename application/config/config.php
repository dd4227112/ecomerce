...
/**
 * 
 * wrong place to place a function, but we specifically need it only here
 * @return url
 */
...
$sub_folder = 'localhost' ? '/' . explode('/', $_SERVER['REQUEST_URI'])[1] : '';
$url = $protocol.'://localhost'.$sub_folder;
...
// $config['upload_path']   = './uploads/'; // Path to the upload directory
